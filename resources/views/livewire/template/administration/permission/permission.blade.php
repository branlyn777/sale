                                ...
                                @foreach($permission as $p)
                                    <tr>
                                        <th class="text-center" scope="row">
                                            {{ ($permission->currentpage() - 1) * $permission->perpage() + $loop->index + 1 }}
                                        </th>
                                        <td>
                                            {{ $p->name }}
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <button wire:click.prevent="showModalRole({{ $p->id }})" type="button" class="btn btn-outline-primary btn-sm">
                                                <i class="bi bi-pencil-square"></i>
                                            </button>
                                        </td>
                                        <td class="text-center">
                                            <button wire:click.prevent="check_cistern({{ $p->id }})" type="button" class="btn btn-outline-danger btn-sm">
