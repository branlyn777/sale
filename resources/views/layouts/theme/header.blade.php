            ...
            <ul class="list-unstyled">
                        ...
                        <div class="dropdown-header px-0 text-wrap header-notification-scroll position-relative"
                            ...
                            <div class="list-group list-group-flush w-100">
                                ...
                                <a class="list-group-item list-group-item-action">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <img src="template/images/user/avatar-2.jpg" alt="user-image"
                                                class="user-avtar" />
                                        </div>
                                ...
                                <a class="list-group-item list-group-item-action">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-1">
                                            ...
                                            <p class="text-body fs-6">All done! Now check your inbox as you're in for a
                                                sweet treat! </p>
                                ...
                                <a class="list-group-item list-group-item-action">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <img src="template/images/user/avatar-1.jpg" alt="user-image"
                                                class="user-avtar" />
                                        </div>
                                        <div class="flex-grow-1 ms-1">
                                ...
                                <a class="list-group-item list-group-item-action">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <img src="template/images/user/avatar-3.jpg" alt="user-image"
                                                class="user-avtar" />
                                        </div>
                                        <div class="flex-grow-1 ms-1">
                ...
                <li class="dropdown pc-h-item header-user-profile">
                    <a class="pc-head-link head-link-primary dropdown-toggle arrow-none me-0"
                        data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false"
                        aria-expanded="false">
                        <img src="template/images/user/avatar-2.jpg" alt="user-image" class="user-avtar" />
                        <span>
